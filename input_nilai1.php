...
<!DOCTYPE html>
  <html>
    <head>
    <title>Input Nilai Kelas I</title>
        <meta charset="utf-8">
...
<a class="navbar-brand" href="#"><b>TPQ</b></a>
  <a class="navbar-brand btn btn-light">Input Nilai Kelas I</a>
...
<div class="container">
    <div class="jumbotron" >
      <div  class="col-sm-6">
        ...
        // var_dump($s)
        ?>
        <form action="inputpr_nilai1.php" method="POST">
          <div class="row">
            <div class="col-sm-6">
              <label>NIS</label>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <input type="text" name="iqra_123" class="form-control">
            </div>
          </div>
